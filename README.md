...
Alternatively it is possible download the original [dataset](https://www.kaggle.com/c/histopathologic-cancer-detection/data) from Kaggle and extract the files. <br /> <br />
If you downloaded the original dataset from Kaggle it is possible need to: <br /><br />
...
Here it is possible type the dataset directory in which you downloaded / created the training dataset. <br />
...
*Use in case you want to resume your training if for some reason it was stopped, it is possible want to change it to **"True"**.* <br />

**epoch_assignation = 1000** <br />
 it is possible choose a number of epochs for training.* <br />

**filters = 16** <br />
 it is possible choose to change the number of filters* <br />


**optimizer = ADAM_optimizer** <br />
Defaults to: ADAM_optimizer <br />
 it is possible choose other optimizers, for more information look at [main.py](https://github.com/Fabio-Gil-Z/IRUNet/blob/main/Code/main.py)*.<br />


**loss_function   = "MeanAbsoluteError"** <br />
Defaults to: "MeanAbsoluteError" <br />
 it is possible try: "MeanSquaredError"*.

### We have successfully finished configuring our [main.py](https://github.com/Fabio-Gil-Z/IRUNet/blob/main/Code/main.py) file. <br />
 it is possible run the program with "python3 [main.py](https://github.com/Fabio-Gil-Z/IRUNet/blob/main/Code/main.py)" execution line at the terminal. <br />
...
####  it is possible configure the file to change the default path from the sample testing folder and the number of testing pairs (clean,noise), in this case there are only 10 images in our github repository folder for different levels of noise; it is possible configure it to do it for 100, 1000 or the whole test dataset at 57458 testing pairs. The idea is to use it with the [noise_10](https://drive.google.com/drive/folders/1PdTrAV-PUpFhdvhFtfOggpLbOpDEouLc?usp=sharing), [noise_25](https://drive.google.com/drive/folders/1PdTrAV-PUpFhdvhFtfOggpLbOpDEouLc?usp=sharing) and [noise_50](https://drive.google.com/drive/folders/1PdTrAV-PUpFhdvhFtfOggpLbOpDEouLc?usp=sharing) testing datasets*. <br /> <br />
...
We only need to state two things, the path to the clean image and the **outputput folder** which defaults to [noise_Images_Created_By_User](https://github.com/Fabio-Gil-Z/IRUNet/tree/main/Code/Util/noise_Images_Created_By_User) and the expected output can be seen in the same folder. <br />
 it is possible choose the level of corruption, which is stated as **noise_standard_deviation**. <br /><br /><br /><br /><br />
